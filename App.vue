<template>
	<div id="app">
		...
		<div class="lodingwrap" v-show="loadingShow">
			<radial-progress-bar :diameter="200" :completed-steps="completedSteps" :total-steps="totalSteps" class="loading">
				<p v-if="completedSteps!==100">Hey,你好呀!<br />{{completedSteps}}%<br /></p>
...
<script>
	...
	export default {
		...
		created() {
			...
			console.log('%c 嘿,你好呀!\n这里并没有什么新鲜的东西可以看的,你可以仔细在我博客里去找找。\n——iBaiWei\'s blog', 'color: #333;font-size: 12px;font-weight: light;font-family:font1;line-height:2em;')
		},
		mounted() {
			this.addLoad()
		},
