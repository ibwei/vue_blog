          ...
          <Card class="card-style">
            ...
            <ul class="list">
              ...
              <li>
                <span>新浪微博:</span>
                <a
                  href="https://weibo.com/u/2878406514?is_hot=1"
                  target="_blank"
                >https://weibo.com/me</a>
              </li>
              <li>
                <span>Twitter:</span>
